...
//!
//! Handles creating new game instances via both API and web UI.

use crate::db;
use crate::templates::{ErrorTemplate, GameStartedTemplate};
use crate::validators;
use crate::web::types::{CreateGameRequest, CreateGameResponse, ErrorResponse};
