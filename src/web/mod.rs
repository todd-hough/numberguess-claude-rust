//! Web server module.
//!
//! Provides the HTTP/HTTPS server with feature-based handler organization.
//! Handlers are organized by feature (game, guess, difficulty, health)
//! making it easy to navigate and scale the codebase.

pub mod handlers;
pub mod types;

use handlers::{create_game_api, create_game_web, difficulty_preview, health_check, make_guess_api, make_guess_web};
use axum::{
    Router,
    routing::{get, post},
};
